...
function Characters()
{
    ...
    $query = "INSERT INTO characters (name, user, content) VALUES('$name','$userid', JSON_OBJECT('name', '$name', 'vision', '$vision', 'nation', '$nation', 'birthday', '$birthday', 'affiliation', '$affiliation', 'description', '$description', 'weapon','$weapon' , 'card', '$card'))";
    error_log($query);
